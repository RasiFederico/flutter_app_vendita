...
// NOTA: Questo screen usa il modello statico Product (mock data).
// Il pulsante "Contatta venditore" è disabilitato perché il modello Product
// non ha un userId Supabase reale. Usa listing_screen.dart per annunci reali.
...
class _ProductScreenState extends State<ProductScreen> {
                  ...
                  child: DecoratedBox(
                    decoration: BoxDecoration(
                      gradient: RadialGradient(
                        ...
                        radius: 0.8,
                        colors: [
                          SwabbitTheme.accent2.withOpacity(0.15),
                          Colors.transparent,
                        ],
                      ),
                    ),
      ...
      children: [
        Wrap(
          ...
          children: [
            ...
            if (p.hasShipping)
              const _Badge('Spedizione', color: SwabbitTheme.green),
            if (p.isNegotiable)
              const _Badge('Trattabile', color: SwabbitTheme.yellow),
          ],
        ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Row(
            children: [
              _SmallActionButton(onTap: () {}, icon: Icons.ios_share_rounded),
              const SizedBox(width: 8),
              GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: _isFav
                        ? SwabbitTheme.accent3.withOpacity(0.1)
                        : SwabbitTheme.surface3,
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                        color: _isFav
                            ? SwabbitTheme.accent3.withOpacity(0.4)
                            : SwabbitTheme.border),
                  ),
                  child: Icon(
                    _isFav
                    ...
                    color:
                        _isFav ? SwabbitTheme.accent3 : SwabbitTheme.text2,
                    size: 20,
                  ),
                ),
              ),
  ...
  Widget _buildSpecs() {
    ...
    return Column(
      ...
      children: [
        Text('Specifiche',
            style: SwabbitTheme.displayStyle.copyWith(fontSize: 15)),
        const SizedBox(height: 12),
        GridView.count(
          shrinkWrap: true,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: const TextStyle(
                fontSize: 13, color: SwabbitTheme.text2, height: 1.7),
          ),
          const SizedBox(height: 8),
          GestureDetector(
    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: SwabbitTheme.accent.withOpacity(0.3), width: 2),
                ),
                child: Center(
                  child: Text(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color:
                                    SwabbitTheme.accent.withOpacity(0.2)),
                          ),
          ...
          Row(
            children: [
              _SellerStat('${p.sellerSales}', 'Vendite',
                  color: SwabbitTheme.green),
              _SellerStat('${p.sellerFollowers}', 'Follower',
                  color: SwabbitTheme.yellow),
            ...
            children: [
              Expanded(
                child: _ChatButton(
                  ...
                  onTap: () {
                    // product_screen usa dati mock senza userId Supabase.
                    // Per chat reali usa listing_screen.dart.
                  },
                  color: SwabbitTheme.accent,
              ...
              const SizedBox(width: 8),
              _SmallActionButton(
                  onTap: () {}, icon: Icons.phone_outlined),
            ],
          ),
        ],
      ),
...
class _SmallActionButton extends StatelessWidget {
  final VoidCallback onTap;
  final IconData icon;
  const _SmallActionButton({required this.onTap, required this.icon});
